...
export const PlantCoralFoodCalculator = () => {
  ...
  const products = [
    ...
    {
      label: "Seachem Flourish Excel - +40% Water Change",
      baseDoseMl: 5,
      dosePerLitre: 40,
      disableCaps: false,
      overdose: [],
    ...
    {
      label: "Seachem Flourish Excel - Maintenance Dose",
      baseDoseMl: 5,
      dosePerLitre: 200,
      disableCaps: false,
      overdose: [],
    ...
    {
      label: "Seachem Flourish Potassium",
      baseDoseMl: 5,
      dosePerLitre: 125,
      disableCaps: false,
      overdose: [],
    ...
    {
      label: "Seachem Flourish Advance",
      baseDoseMl: 5,
      dosePerLitre: 80,
      disableCaps: false,
      overdose: [],
    ...
    {
      label: "Seachem Flourish Nitrogen",
      baseDoseMl: 2.5,
      dosePerLitre: 160,
      disableCaps: false,
      overdose: [],
    ...
    {
      label: "API Leaf Zone Plant Fertilizer",
      baseDoseMl: 5,
      dosePerLitre: 38,
      disableCaps: false,
      overdose: [],
  ...
  return (
    <Grid direction="column" gap={8}>
      <CalculatorConfigSetup
        title={isFresh ? "Plant Food Calculator" : "Coral Food Calculator"}
        products={products}
